...
- Last PASS：2026-09-09 Asia/Shanghai，**840** 题，issues=0
...
预期输出：`{ total: 840, daily: 620, mock: 220 }`（`questions` 数组末尾 `...mockPaperQuestions`，220 = 85+25+85+25）。
...
4. 题量与覆盖度复查：当前全站 840 题（非试卷日 ≥12；W7d1 知产/标准已加厚；上午模考各 85）；可按模块正确率与错题热点定向加题。
...
*文档刷新：2026-09-09（W7d1 知产/标准题加厚）。题量以仓库内 data/questions.ts + data/mock-papers.ts 导出数组为准（全站约 **840**）。*
