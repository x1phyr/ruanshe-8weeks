...
- Last PASS：2026-09-09 Asia/Shanghai，**991** 题，issues=0
...
预期输出：`{ total: 991, daily: 771, mock: 220 }`（`questions` 数组末尾 `...mockPaperQuestions`，220 = 85+25+85+25）。
...
4. 题量与覆盖度复查：当前全站 991 题（非试卷日 ≥12；W3 操作系统软考陷阱已再加厚；上午模考各 85）；可按模块正确率与错题热点定向加题。
...
*文档刷新：2026-09-09（W3 操作系统软考陷阱再加厚 +22）。题量以仓库内 data/questions.ts + data/mock-papers.ts 导出数组为准（全站约 **991**）。*
